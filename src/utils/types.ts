...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    price: 1200, // Updated prices to be in shekels (roughly converted)
  ...
  },
  {
    ...
    price: 6500, // Updated prices to be in shekels (roughly converted)
  ...
  },
  {
    ...
    price: 1600, // Updated prices to be in shekels (roughly converted)
  ...
  },
  {
    ...
    price: 900, // Updated prices to be in shekels (roughly converted)
  ...
  },
  {
    ...
    price: 11500, // Updated prices to be in shekels (roughly converted)
  ...
  },
  {
    ...
    price: 1100, // Updated prices to be in shekels (roughly converted)
